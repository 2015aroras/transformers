...
class Olmoe2IntegrationTest(unittest.TestCase):
    ...
    def test_model_1b_logits_bfloat16(self):
        ...
        model = Olmoe2ForCausalLM.from_pretrained("allenai/OLMo-2-0425-1B").to(torch_device, torch.bfloat16)
    ...
    def test_model_7b_logits(self):
        input_ids = [[1, 306, 4658, 278, 6593, 310, 2834, 338]]
        model = Olmoe2ForCausalLM.from_pretrained("shanearora/OLMoE2-7B-1124-hf").to(torch_device, dtype=torch.bfloat16)
        out = model(torch.tensor(input_ids, device=torch_device)).logits.float()
        # Expected mean on dim = -1
        expectations = Expectations(
            {
    ...
    def test_model_7b_greedy_generation(self):
        ...
        tokenizer = AutoTokenizer.from_pretrained("shanearora/OLMoE2-7B-1124-hf", device_map="auto")
        model = Olmoe2ForCausalLM.from_pretrained("shanearora/OLMoE2-7B-1124-hf", device_map="auto")
    ...
    def test_simple_encode_decode(self):
        rust_tokenizer = AutoTokenizer.from_pretrained("shanearora/OLMoE2-7B-1124-hf")
    ...
    def test_export_static_cache(self):
        ...
        olmoe2_model = "shanearora/OLMoE2-7B-1124-hf"

        tokenizer = AutoTokenizer.from_pretrained(olmoe2_model, pad_token="</s>", padding_side="right")
        ...
        model = Olmoe2ForCausalLM.from_pretrained(
            olmoe2_model,
            device_map=device,
            torch_dtype=dtype,
