...
"""Testing suite for the PyTorch OLMoo model."""
...
from transformers import OlmooConfig, is_torch_available, set_seed
...
class OlmooModelTester:
    ...
    def create_and_check_model(
        ...
        model = OlmooModel(config=config)
    ...
    def create_and_check_for_causal_lm(
        ...
        model = OlmooForCausalLM(config=config)
        model.to(torch_device)
        model.eval()
...
class OlmooModelTest(ModelTesterMixin, GenerationTesterMixin, PipelineTesterMixin, unittest.TestCase):
    ...
    def setUp(self):
        self.model_tester = OlmooModelTester(self)
        self.config_tester = ConfigTester(self, config_class=OlmooConfig, hidden_size=37)
    ...
    @unittest.skip(reason="OLMoo does not support head pruning.")
    ...
    @unittest.skip(reason="OLMoo buffers include complex numbers, which breaks this test")
    ...
    def test_model_rope_scaling(self, scaling_type):
        ...
        original_model = OlmooModel(config)
        ...
        scaled_model = OlmooModel(config)
...
@require_torch
class OlmooIntegrationTest(unittest.TestCase):

    @slow
    def test_model_7b_logits(self):
        input_ids = [[1, 306, 4658, 278, 6593, 310, 2834, 338]]
        model = OlmooForCausalLM.from_pretrained("allenai/OLMoo-7B-hf", device_map="auto")
    ...
    def test_model_7b_greedy_generation(self):
        ...
        tokenizer = AutoTokenizer.from_pretrained("allenai/OLMoo-7B-hf", device_map="auto")
    ...
    def test_fast_special_tokens(self):
        fast_tokenizer = GPTNeoXTokenizerFast.from_pretrained("allenai/Olmoo-7B-hf")
    ...
    def test_simple_encode_decode(self):
        rust_tokenizer = GPTNeoXTokenizerFast.from_pretrained("allenai/Olmoo-7B-hf")
    ...
    def test_export_static_cache(self):
        ...
        olmoo_model = "allenai/Olmoo-7B-hf"

        tokenizer = AutoTokenizer.from_pretrained(olmoo_model, pad_token="</s>", padding_side="right")
        ...
        batch_size = 1
        model = OlmooForCausalLM.from_pretrained(
            olmoo_model,
            device_map=device,
            torch_dtype=dtype,
