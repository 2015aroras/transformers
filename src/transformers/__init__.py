...
try:
    ...
    _import_structure["models.olmo"].append("OLMoTokenizer")
...
try:
    ...
    _import_structure["models.olmo"].extend(["FlaxOLMoForCausalLM", "FlaxOLMoModel", "FlaxOLMoPreTrainedModel"])
...
if TYPE_CHECKING:
    ...
    try:
        ...
        from .models.olmo import OLMoTokenizer
