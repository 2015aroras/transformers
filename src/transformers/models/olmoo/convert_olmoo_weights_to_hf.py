...
Sample usage:
```
python src/transformers/models/olmo/convert_olmoo_weights_to_hf.py \
...
def write_model(
    ...
    base = olmoo_config.get("rope_theta", 10000.0)
