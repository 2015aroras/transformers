...
class Olmo2RetrofitConfig(Olmo2Config):
    r"""
    This is the configuration class to store the configuration of a [`Olmo2RetrofitModel`]. It is used to instantiate an OLMo2 Retrofit
    model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
    defaults will yield a similar configuration to that of the [allenai/olmo2-retrofit](https://huggingface.co/allenai/olmo2-retrofit).
    ...
    Args:
        vocab_size (`int`, *optional*, defaults to 100278):
            Vocabulary size of the Olmo2Retrofit model. Defines the number of different tokens that can be represented by the
            `inputs_ids` passed when calling [`Olmo2RetrofitModel`]
    ...
    ```python
    >>> from transformers import Olmo2RetrofitModel, Olmo2RetrofitConfig

    >>> # Initializing a Olmo2Retrofit 7B style configuration
    >>> configuration = Olmo2RetrofitConfig()

    >>> # Initializing a model from the Olmo2Retrofit 7B style configuration
    >>> model = Olmo2RetrofitModel(configuration)
...
__all__ = [
    ...
    "Olmo2RetrofitModel",
    "Olmo2RetrofitPreTrainedModel",  # noqa: F822
]
